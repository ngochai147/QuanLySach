...
//            System.out.println("Kho hàng: " + khoHang.getMaKhoHang());
    ...
    private void initComponents() {
        ...
        jPanel_NhapKho = new JPanel();
        jLabel1 = new JLabel();
        jLabel9 = new JLabel();
        tf_denKho = new JTextField();
        ...
        tbl_phieuNhapKho = new JTable();
        jLabel2 = new JLabel();
        jdc_ngayLapPN = new com.toedter.calendar.JDateChooser();
        tf_isbn = new JTextField();
        jLabel12 = new JLabel();
        tf_soLuong = new JTextField();
        btn_taoPN = new JButton();
        jLabel5 = new JLabel();
        jLabel14 = new JLabel();
        btn_huy = new JButton();
        background = new JLabel();

        setPreferredSize(new Dimension(1612, 733));

        jPanel_NhapKho.setPreferredSize(new Dimension(1612, 733));
        jPanel_NhapKho.setLayout(null);

        jLabel1.setHorizontalAlignment(SwingConstants.CENTER);
        jLabel1.setIcon(new ImageIcon(getClass().getResource("/img/jLabel_TaoPhieuNhapKho.png"))); // NOI18N
        jPanel_NhapKho.add(jLabel1);
        jLabel1.setBounds(0, 0, 1580, 130);

        jLabel9.setFont(new Font("Arial", 1, 30)); // NOI18N
        jLabel9.setForeground(new Color(255, 255, 255));
        jLabel9.setIcon(new ImageIcon(getClass().getResource("/img/book-stack.png"))); // NOI18N
        jLabel9.setText("Nhập sách");
        jPanel_NhapKho.add(jLabel9);
        jLabel9.setBounds(900, 150, 190, 36);

        tf_denKho.setPreferredSize(new Dimension(64, 40));
        ...
        btn_them.setBackground(new Color(102, 102, 0));
        btn_them.setFont(new Font("Arial", 1, 20)); // NOI18N
        btn_them.setForeground(new Color(255, 255, 255));
        btn_them.setText("Thêm");
        btn_them.setPreferredSize(new Dimension(120, 42));
        ...
        jLabel7.setFont(new Font("Arial", 1, 20)); // NOI18N
        ...
        jLabel10.setFont(new Font("Arial", 1, 20)); // NOI18N
        jLabel10.setForeground(new Color(255, 255, 255));
        jLabel10.setText("ISBN");
        jPanel_NhapKho.add(jLabel10);
        jLabel10.setBounds(1010, 190, 60, 40);

        tbl_phieuNhapKho.setFont(new Font("Times New Roman", 0, 20)); // NOI18N
        tbl_phieuNhapKho.setModel(new DefaultTableModel(
                new Object [][] {
        ...
        tbl_phieuNhapKho.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
        ...
        jLabel2.setFont(new Font("Arial", 1, 30)); // NOI18N
        jLabel2.setForeground(new Color(255, 255, 255));
        jLabel2.setText("Thông tin");
        jPanel_NhapKho.add(jLabel2);
        jLabel2.setBounds(90, 140, 140, 36);

        jdc_ngayLapPN.setFont(new Font("Times New Roman", 1, 20)); // NOI18N
        jPanel_NhapKho.add(jdc_ngayLapPN);
        jdc_ngayLapPN.setBounds(260, 190, 340, 40);

        tf_isbn.setPreferredSize(new Dimension(64, 40));
        ...
        jLabel12.setFont(new Font("Arial", 1, 20)); // NOI18N
        jLabel12.setForeground(new Color(255, 255, 255));
        jLabel12.setText("Số lượng");
        jPanel_NhapKho.add(jLabel12);
        jLabel12.setBounds(970, 250, 90, 40);

        tf_soLuong.setFont(new Font("Times New Roman", 0, 20)); // NOI18N
        tf_soLuong.setPreferredSize(new Dimension(64, 40));
        ...
        btn_taoPN.setBackground(new Color(102, 102, 0));
        btn_taoPN.setFont(new Font("Arial", 1, 20)); // NOI18N
        btn_taoPN.setForeground(new Color(255, 255, 255));
        btn_taoPN.setText("Tạo phiếu nhập");
        btn_taoPN.setPreferredSize(new Dimension(120, 42));
        ...
        btn_huy.setBackground(new Color(153, 0, 51));
        btn_huy.setFont(new Font("Arial", 1, 20)); // NOI18N
        btn_huy.setForeground(new Color(255, 255, 255));
        btn_huy.setText("Hủy");
        btn_huy.setPreferredSize(new Dimension(120, 42));
        ...
        background.setBackground(new Color(102, 102, 0));
        background.setIcon(new ImageIcon(getClass().getResource("/img/anhnen.jpg"))); // NOI18N
        background.setPreferredSize(new Dimension(1612, 733));
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(jPanel_NhapKho, GroupLayout.DEFAULT_SIZE, 2479, Short.MAX_VALUE)
                                .addGap(0, 0, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(jPanel_NhapKho, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void btn_taoPNActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {//GEN-FIRST:event_btn_taoPNActionPerformed
        DefaultTableModel model = (DefaultTableModel) tbl_phieuNhapKho.getModel();
        ...
        dsCTPNK.forEach(System.out::println);
...
//      JOptionPane.showMessageDialog(null, "Đã lưu phiếu nhập kho.");
    ...
    private JPanel jPanel_NhapKho;
    private JScrollPane jScrollPane1;
    private com.toedter.calendar.JDateChooser jdc_ngayLapPN;
    private JTable tbl_phieuNhapKho;
    private JTextField tf_denKho;
