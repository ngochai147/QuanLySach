...
public class BlankPlotChart_BarChart extends JComponent {
    ...
    public void setBlankPlotChatRender_BarChart(BlankPlotChatRender_BarChart blankPlotChatRender_BarChart) {
        this.blankPlotChatRender_BarChart = blankPlotChatRender_BarChart;
    }
    ...
    private BlankPlotChatRender_BarChart blankPlotChatRender_BarChart;

    public BlankPlotChart_BarChart() {
    ...
    private void renderSeries(Graphics2D g2) {
        if (blankPlotChatRender_BarChart != null) {
            Insets insets = getInsets();
            double textWidth = getMaxValuesTextWidth(g2);
            double textHeight = getLabelTextHeight(g2);
            double spaceText = 5;
            ...
            double locationX = insets.left + textWidth + spaceText;
            for (int i = 0; i < labelCount; i++) {
                blankPlotChatRender_BarChart.renderSeries(this, g2, getRectangle(i, height, space, locationX, insets.top), i);
            }
        }
    }
    ...
    private String getChartText(int index) {
        if (blankPlotChatRender_BarChart != null) {
            return blankPlotChatRender_BarChart.getLabelText(index);
        } else {
            return "Label";
        }
    }
